...
def preprocess(data):
    ...
    listings = listings.loc[:,['listing_url','price', 'price_currency', 'brand', 'model', 'mileage', 'body_type', 'condition', 'fuel_type', 'transmission', 'engine_capacity', 'year_of_manufacture', 'trim_edition', 'listing_date']]
    return listings